export default function IconBus(props) {
  return(
    <svg viewBox='0 0 15 15' height={20} width={20} style={{transform:'translate(0, 2px)'}}>
      <rect fill='none' x={0} y={0} width={20} height={20} />
      <path fill={props.color || '#000000'} transform='translate(0, 0)'
