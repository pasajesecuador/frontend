        ...
        style={{enableBackground:'new 0 0 512 512'}} xmlSpace="preserve" >
          <g>
            <g xmlns="http://www.w3.org/2000/svg">
              <path transform='translate(40, 30)' 
              ...
              c-14.424-20.556-23.385-46.777-23.385-68.432C125.19,49.537,159.727,15,202.178,15z" fill={props.color || '#ffffff'}/>
              ...
              C307.229,369.93,255.795,389.348,202.174,389.348z" fill={props.color || '#ffffff'} transform='translate(40, 50)' />
            </g>
          </g>
        </svg>
    </div>
